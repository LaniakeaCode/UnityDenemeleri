Btk akademideki unity oyun geliştirme eğitiminde verilen dragdrop kodundan farklı olarak oyun ekranı üzerinde belirli bir alana objeyi getirip bıraktığımızda puan kazandığımız bir kod yazdım.
